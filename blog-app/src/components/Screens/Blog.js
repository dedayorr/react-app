    ...
    <>
      <div className=" ">
        <div className="md:flex">
          ...
          <div className="">
            <p className="rotate text-6xl ml-[-80%] font-extrabold md:text-8xl">
              Most popular
            </p>

            <div className=" border w-[89%] relative top-0 right-0 left-10 p-[2%] bg-[#7285d3a9] text-white md:w-[70%] md:gap-[10px] md:flex md:flex-col md:rounded-2xl">
        ...
        <div className="md:grid md:grid-cols-4 mb-[20px]">
          <div
            className="flex flex-col gap-2 bg-[#4e65c34e] w-[90%] mx-auto p-[2%] text-white mt-[20px] justify-between rounded-2xl"
          ...
          >
            <a
              ...
              target="_blank"
            >
              <p className="font-extrabold text-2xl text-[#000] hover:text-[#4e66c3]">
                {truncate(
                  "Microsoft’s new Copilot will change Office documents forever",
                  100
                )}
          ...
          >
            ...
            <p className="text-sm">Mar 20, 2023, 9.27 PM</p>
          </div>
          ...
          >
            ...
            <p className="font-bold text-[#4e66c3]">By BONIFAIC </p>
      ...
      <div className="bg-[#000] p-[5%] mb-[20px] md:flex md:gap-[40px]">
          ...
          <div className="bg-white rounded-lg p-[3%]">
            ...
            <div className="flex flex-col gap-[20px] text-lg">
              <div className="flex gap-[5px]">
                ...
                <a href="https://www.digitaltrends.com/gaming/tchia-review-pc-epic-games-store/" target="_blank">
              ...
              <div className="flex gap-[5px]">
                ...
                <a href="https://www.digitaltrends.com/movies/boston-strangler-2023-movie-review/" target="_blank">
                  {" "}
                  <p className="hover:text-[#4e66c3]">
              ...
              <div className="flex gap-[5px]">
                ...
                <a href="https://www.digitaltrends.com/movies/inside-2023-movie-review/" target="_blank">
                  <p className="hover:text-[#4e66c3]">
              ...
              <div className="flex gap-[5px]">
                ...
                <a href="https://www.digitaltrends.com/gaming/resident-evil-4-review-ps5/" target="_blank">
                  <p className="hover:text-[#4e66c3]">
              ...
              <div className="flex gap-[5px]">
                ...
                <a href="https://www.digitaltrends.com/home-theater/klipsch-the-sevens-review/" target="_blank">
                  <p className="hover:text-[#4e66c3]">
        ...
        <div className="md:flex-2">
          ...
          <div className="flex gap-[5px] mt-[10px]">
                <img className="md:hidden" src="./computing.webp" alt="img" width={100} />
                <img className="hidden md:block" src="./computing.webp" alt="img" width={200} />
                <a href="https://www.digitaltrends.com/computing/bitwarden-autofill-may-be-unsafe/" target="_blank">
