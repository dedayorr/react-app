  ...
  return (
    ...
    <div className="flex justify-between items-center bg-slate-400">
      <div className="flex text-[10px] gap-[5px] ">
        <p className="flex justify-center items-center"><BsTelephoneForwardFill/> Telephone: 09127563048</p>
        <p className="flex justify-center items-center"><AiOutlineMail/>Email: dedayo16@gmail.com</p>
      </div>
